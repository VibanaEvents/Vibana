...
const socials = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/vibanaevents/",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@vibanaevents",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61585658215699&sk=followers",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
    ...
    <div className={`flex items-center gap-5 ${className}`}>
      {socials.map(({ label, href, icon }) => (
        <Link
          ...
          aria-label={label}
          className={`transition-opacity hover:opacity-70 ${iconClassName}`}
        >
          {icon}
        </Link>
      ))}
