...
const team = [
  { name: "Joris van Velthooven", role: "Founder",     photo: "/image-Joris.png" },
  { name: "Bram van Andel",       role: "Founder",     photo: "/image-Bram.png"  },
  { name: "Thijs Wieman",         role: "Co-Founder",  photo: "/image-Thijs.png" },
];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 pt-32 pb-16">
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        <p className="text-lg">
          Vibana is an Afrobeats music events concept born out of a love for Afrobeats.
          Based in the Netherlands, we create spaces where people come together to
          celebrate the richness of Afrobeats, Amapiano, Afro House and everything in between.
        </p>
      </div>
